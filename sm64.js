...
var ASM_CONSTS = {
 ...
 8779014: function() {if (typeof window.__sm64ViewportSize === 'function') { return window.__sm64ViewportSize().w; } return document.documentElement.clientWidth || window.innerWidth;},  
 8779041: function() {if (typeof window.__sm64ViewportSize === 'function') { return window.__sm64ViewportSize().h; } return document.documentElement.clientHeight || window.innerHeight;},  
  8779069: function() {if (typeof window.__sm64ViewportSize === 'function') { return window.__sm64ViewportSize().w; } return document.documentElement.clientWidth || window.innerWidth;},  
  8779101: function() {if (typeof window.__sm64ViewportSize === 'function') { return window.__sm64ViewportSize().h; } return document.documentElement.clientHeight || window.innerHeight;},  
 ...
 8779725: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext && SDL2.audioContext.state === 'suspended' && SDL2.audioContext.resume) { SDL2.audioContext.resume(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 ...
 8781930: function($0, $1, $2, $3) {var SDL2 = Module['SDL2']; var requestedBufferSize = $1; var outputBufferSize = (requestedBufferSize <= 4096 && 4096 % requestedBufferSize === 0) ? 4096 : requestedBufferSize; SDL2.audio.scriptProcessorNode = SDL2.audioContext['createScriptProcessor'](outputBufferSize, 0, $0); SDL2.audio.scriptProcessorNode['onaudioprocess'] = function (e) { if ((SDL2 === undefined) || (SDL2.audio === undefined)) { return; } var outputBuffer = e['outputBuffer']; var bufferLength = outputBuffer['getChannelData'](0).length; if (bufferLength <= requestedBufferSize) { SDL2.audio.currentOutputBuffer = outputBuffer; dynCall('vi', $2, [$3]); return; } for (var offset = 0; offset < bufferLength; offset += requestedBufferSize) { SDL2.audio.currentOutputBuffer = { 'numberOfChannels': outputBuffer['numberOfChannels'], 'getChannelData': function(c) { return outputBuffer['getChannelData'](c).subarray(offset, offset + requestedBufferSize); } }; dynCall('vi', $2, [$3]); } }; SDL2.audio.scriptProcessorNode['connect'](SDL2.audioContext['destination']); if (SDL2.audioContext.state === 'suspended' && SDL2.audioContext.resume) { SDL2.audioContext.resume(); }},  
...
// {{PRE_LIBRARY}}
  ...
  function _emscripten_set_main_loop(func, fps, simulateInfiniteLoop, arg, noSetTiming) {
      ...
      if (simulateInfiniteLoop) {
        ...
        if (window.__sm64Mobile) {
          if (typeof window.__sm64FitCanvas === 'function') {
            window.__sm64FitCanvas();
          }
          return;
        }
        var w, h;
        if (typeof window.__sm64ViewportSize === 'function') {
          var lim = window.__sm64ViewportSize();
          w = lim.w;
          h = lim.h;
        } else {
          w = document.documentElement.clientWidth || window.innerWidth || 320;
          h = document.documentElement.clientHeight || window.innerHeight || 240;
        }
        canvas.widthNative = w;
        canvas.heightNative = h;
        canvas.width = w;
        canvas.height = h;
        if (typeof window.__sm64FitCanvas === 'function') {
          window.__sm64FitCanvas();
  ...
  var __specialEventTargets=[0, typeof document !== 'undefined' ? document : 0, typeof window !== 'undefined' ? window : 0];function __findEventTarget(target) {
      ...
      if (!canvas) return -4;
      if (typeof window.__sm64CanvasSize === 'function') {
        var lim = window.__sm64CanvasSize();
        HEAP32[((width)>>2)]=lim.w;
        HEAP32[((height)>>2)]=lim.h;
      } else if (typeof window.__sm64ViewportSize === 'function') {
        var lim = window.__sm64ViewportSize();
        HEAP32[((width)>>2)]=lim.w;
        HEAP32[((height)>>2)]=lim.h;
      } else {
  ...
  function _emscripten_glEnable(x0) {
      if (window.__sm64Mobile && x0 === 0x0C11) return;
      GLctx['enable'](x0);
    }
  ...
  function _emscripten_glViewport(x0, x1, x2, x3) {
      if (typeof window.__sm64ViewportSize === 'function') {
        var lim = window.__sm64ViewportSize();
        if (x2 > lim.w) x2 = lim.w;
        if (x3 > lim.h) x3 = lim.h;
      }
